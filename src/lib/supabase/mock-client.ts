...
const TABLE_DATA_MAP: Record<string, any[]> = {
  ...
  events: DEMO_EVENTS,
  services: DEMO_SERVICE_SERVICES,
  packages: DEMO_PACKAGES,
  event_functions: DEMO_EVENT_FUNCTIONS,
  event_team_assignments: DEMO_TEAM_ASSIGNMENTS,
  event_costs: DEMO_EVENT_COSTS,
  editing_tasks: DEMO_EDITING_TASKS,
  event_deliverables: DEMO_DELIVERABLES,
  album_orders: DEMO_ALBUM_ORDERS,
  quotation_items: DEMO_QUOTATION_ITEMS,
